...
gb.configure_default_column(sizeColumnsToFit=False, enablePivot=False, enableValue=False, enableRowGroup=True, suppressColumnsToolPanel=True,menuTabs=['filterMenuTab'],enableBrowserTooltips=False,tooltipShowDelay=0)
...
# gb.tooltipShowDelay(0)
go = gb.build()

ag = AgGrid(df, height=1000, gridOptions=go, theme="streamlit", enableBrowserTooltips=False,fit_columns_on_grid_load=True,allow_unsafe_jscode=True,custom_css=custom_css,use_checkbox=True,update_mode=GridUpdateMode.MODEL_CHANGED, columns_auto_size_mode=ColumnsAutoSizeMode.FIT_CONTENTS, enable_quicksearch=True)
