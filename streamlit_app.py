...
gb.configure_columns(["Summary","Project Name","Questions We Need Answered"],wrapText = True)
gb.configure_columns(["Summary","Questions We Need Answered"],autoHeight = True)
